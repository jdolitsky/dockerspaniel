...
ds.generateContents = function(spaniel, tags, callback, is_child, root_dir) {
        ...
        async.eachSeries(spaniel.steps, function(step, done) {
            ...
            if (step.file) {
                try {
                    ...
                    contents.push(template(data).trim());
                }
                catch (e) {
                    return done(e);
                }
                ...
                try {
                    ...
                    contents.push(step.instruction.toUpperCase()+' '+template(data));
                }
                catch (e) {
                    return done(e);
                }
